  ...
  return (
    <section className="w-full max-w-5xl py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div className="space-y-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-gold/10 border border-brand-gold/20 text-accent text-xs font-medium uppercase tracking-tighter">
          <Wand2 size={14} />
          Active Experiment
        </div>
        ...
        <p className="text-accent/70 leading-relaxed text-lg font-light">
